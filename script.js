...
` },
  ...
  立憲主義とは、国家権力を憲法で縛ることで、国民の基本的人権や自由を守ろうとする政治のあり方。
権力の暴走を防ぐため、最高法規である憲法に基づいて政治を行うという、近代民主主義の根幹となる思想・制度

立憲主義は「憲法で権力を縛り、人権を守る」思想であり、民主主義は「多数決で物事を決める」仕組みです。前者は権力の暴走（独裁）を防ぐ制限、後者は政治参加の正当性を追求します。現代は多数決が人権を侵害しないよう、憲法で制限をかける「立憲民主主義」が原則です。

1. 立憲主義（憲法による制限）
目的: 国家権力を憲法で制限し、個人の人権を保障すること。
特徴: 憲法は「国民が権力を縛るルール」であり、政府はこの憲法に従う必要がある。
役割: 少数派の権利を多数派の横暴から守る。 
2. 民主主義（多数決の原理）
目的: 国民が政治の主体となり、選挙や多数決で物事を決定すること。
